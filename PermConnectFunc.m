...
n=NetThresh;
MyThresh1=ceil((1-n)*(332*332-332)); % Remove top percent of matrix
VCTRL100=con1(:);
...
deg1=numel(find(abs(con1out)>0)); % Degrees of connectivity corresponds to number of nonzero indexes in matrix!!
